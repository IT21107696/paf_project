...
const Post = (props) => {
    ...
    const setCurrentUserRatinfsFromDb = () => {
        axios.get(`${config.baseUrl}/rating`).then((value) => {
        ...
        <div
            ...
            <Modal
                ...
                onOk={async (e) => {
                    if (!rateId) {
                        const data = {
                            "ratedBy": localStorage.getItem("uid"),
                            "ratedTo": props.id,
                            "ratings": rating,
                        }
                        await axios.post(`${config.baseUrl}/rating`, data).then((value) => {
                            message.success("Rated succesfully")
                        }).catch(err => {
                        ...
                        await axios.put(`${config.baseUrl}/rating/${rateId}`, data).then((value) => {
                            message.success("Rated updated succesfully")
                        }).catch(err => {
                            message.error("Rating failed")
                        })
                    }
